...
import { X, AlertTriangle, ChevronRight, Wand2, BookOpen } from 'lucide-react'
            ...
            <div className="max-w-3xl mx-auto">
              <div className="mb-6">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  {data.clauses.length} clauses · Language: {data.language.name} · Translated via Bhashini NMT
                </p>
                {/* Legend */}
