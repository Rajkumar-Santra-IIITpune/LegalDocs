...
import { AlertTriangle, CheckCircle2, AlertCircle, Shield, FileText, Clock, Zap, ArrowRight, TrendingUp } from 'lucide-react'
              ...
              <div className="h-32">
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    ...
                    <Tooltip
                      contentStyle={{ background: 'hsl(224 15% 10%)', border: '1px solid hsl(224 15% 18%)', borderRadius: 8 }}
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="col-span-12 md:col-span-6">
          <Card>
            ...
            <CardContent>
              <div className="h-44">
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={RISK_SCORE_HISTORY}>
                    <CartesianGrid strokeDasharray="3 3" stroke="rgba(255,255,255,0.04)" />
                    <XAxis dataKey="month" tick={{ fontSize: 11, fill: '#6b7280' }} axisLine={false} tickLine={false} />
                    <YAxis domain={[0, 100]} tick={{ fontSize: 11, fill: '#6b7280' }} axisLine={false} tickLine={false} />
                    <Tooltip
                      contentStyle={{ background: 'hsl(224 15% 10%)', border: '1px solid hsl(224 15% 18%)', borderRadius: 8, fontSize: 12 }}
                    />
                    <Line type="monotone" dataKey="avgScore" stroke="#a78bfa" strokeWidth={2.5} dot={{ fill: '#a78bfa', r: 3 }} activeDot={{ r: 5 }} />
                  </LineChart>
                </ResponsiveContainer>
              </div>
            </CardContent>
